...
class LCG {
    ...
    LCG (int x0, int a, int modulo, int c) throws Exception {
        if (modulo <= 0)
    ...
    String generateString(int n) throws Exception {
        if (n <= 0)
...
//        String str = "" + x0;
    ...
    static boolean isLCB(String str, SolutionClass sC) throws Exception{
        switch (sC) {
            case Cycle:
     ...
     * It can be proved, than to any cycle can be assigned at least one set of arguments to the LCG generator,
     * used to generate such string.
     * What about if string is too short to loop itself?
     * We can resolve an equations set to check if it's generated by LCG, but it's too difficult.
     ...
     * @return True if given string is generated by the LCG.
